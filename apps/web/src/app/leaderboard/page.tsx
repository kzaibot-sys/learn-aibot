            ...
            {!loading && leaders.length >= 3 && (
              <div className="grid grid-cols-3 gap-3 max-w-lg mx-auto">
                ...
                <div className="flex flex-col items-center gap-2 pt-4">
                  ...
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary/60 to-accent/60 flex items-center justify-center text-white text-sm font-bold shadow-md">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary via-accent to-orange-400 flex items-center justify-center text-white text-base font-bold shadow-xl shadow-primary/30">
                ...
                <div className="flex flex-col items-center gap-2 pt-8">
                  <div className="text-2xl">🥉</div>
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary/40 to-accent/40 flex items-center justify-center text-white text-sm font-bold shadow-md">
                      ...
                      >
                        ...
                        <div className="col-span-5 flex items-center gap-2.5 min-w-0">
                          <div className={`w-9 h-9 rounded-full flex items-center justify-center text-white text-xs font-bold shrink-0 ${
                            i === 0
                              ? 'bg-gradient-to-br from-primary via-accent to-orange-400 shadow-md shadow-primary/25'
