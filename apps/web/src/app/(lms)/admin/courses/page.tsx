    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="rounded-lg bg-gradient-to-r from-orange-500 via-orange-400 to-amber-400 px-4 py-2 text-sm font-medium text-white hover:shadow-lg hover:shadow-orange-500/25 transition-all"
        >
    ...
    <form onSubmit={handleSubmit} className="rounded-3xl border border-border/50 bg-card/50 backdrop-blur-sm p-6 mb-6">
      ...
      <div className="mt-4 flex gap-3">
        <button
          type="submit"
          disabled={saving}
          className="rounded-lg bg-gradient-to-r from-orange-500 via-orange-400 to-amber-400 px-4 py-2 text-sm font-medium text-white hover:shadow-lg hover:shadow-orange-500/25 disabled:opacity-50 transition-all"
        >
