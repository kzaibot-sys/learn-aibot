      ...
      <ScrollReveal>
        <div className="mx-auto max-w-4xl rounded-3xl bg-gradient-to-r from-orange-500 via-orange-400 to-amber-400 p-10 sm:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <a href="/login" className="hover-lift inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-lg font-bold text-primary shadow-2xl transition-all hover:shadow-white/25">
