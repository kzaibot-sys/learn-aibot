...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center px-4 pt-16 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-gradient-to-br from-orange-500/10 to-amber-400/10 rounded-full blur-3xl animate-spin" style={{ animationDuration: '25s' }} />
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        {/* Badge */}
        <div className="animate-fade-in-up inline-flex items-center gap-2 rounded-full bg-orange-500/10 border border-orange-500/30 px-5 py-2.5 text-sm font-semibold text-primary mb-8 animate-pulse-glow shadow-lg shadow-orange-500/10">
        ...
        <div className="animate-fade-in-up flex flex-col items-center gap-4 sm:flex-row sm:justify-center" style={{ animationDelay: '0.3s' }}>
          <a
            href="/login"
            className="hover-lift inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 via-orange-400 to-amber-400 px-8 py-5 text-lg font-bold text-white shadow-2xl shadow-orange-500/40 hover:shadow-orange-500/60 active:scale-95 transition-all"
          >
            {t('landing.hero.cta')}
          ...
          <a
            href="#program"
            className="inline-flex items-center rounded-2xl border border-border/60 hover:border-orange-500/50 bg-card/60 backdrop-blur-md px-8 py-5 text-lg font-bold text-foreground hover:scale-105 active:scale-95 transition-all shadow-sm hover:shadow-md"
          >
